...
export class WorkScheduleController {
    ...
    const workSchedule: WorkScheduleInterface = {
        ...
        monday: [{ name: workScheduleData.monday[0]?.name || '', date: monday.toString().padStart(2, '0') }],
        tuesday: [{ name: workScheduleData.tuesday[0]?.name || '', date: tuesday.getDate().toString().padStart(2, '0') }],
        wednesday: [{ name: workScheduleData.wednesday[0]?.name || '', date: wednesday.getDate().toString().padStart(2, '0') }],
        thursday: [{ name: workScheduleData.thursday[0]?.name || '', date: thursday.getDate().toString().padStart(2, '0') }],
        friday: [{ name: workScheduleData.friday[0]?.name || '', date: friday.getDate().toString().padStart(2, '0') }],
        saturday: [{ name: workScheduleData.saturday[0]?.name || '', date: saturday.getDate().toString().padStart(2, '0') }],
        sunday: [{ name: workScheduleData.sunday[0]?.name || '', date: sunday.toString().padStart(2, '0') }],
      };
